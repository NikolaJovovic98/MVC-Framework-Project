...
<head>
    ...
    <script type="text/javascript" src="<?php echo URLROOT ?>/public/js/newsFilter.js" defer></script>
    <script type="text/javascript" src="<?php echo URLROOT ?>/public/js/usersFilter.js" defer></script>
